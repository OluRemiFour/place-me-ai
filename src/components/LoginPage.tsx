    ...
    <div className="min-h-screen bg-white flex">
      ...
      <div className="flex-1 flex items-center justify-center px-8">
        <div className="w-full max-w-md">
          ...
          <p className="text-base opacity-60 mb-12">
            Access your talent matching dashboard
          </p>
          ...
          <p className="mt-8 text-sm text-center opacity-60">
            ...
            <Link to="/register" className="opacity-100 font-medium hover:underline">
              Create one
            </Link>
          </p>
        </div>
      ...
      <div className="hidden lg:flex flex-1 bg-black text-white items-center justify-center p-12">
        <div className="max-w-lg">
          <div className="font-mono text-8xl font-bold mb-8">87%</div>
          <h2 className="text-3xl font-bold mb-4">
            Average match accuracy
          </h2>
          <p className="text-lg opacity-80">
            Our AI-powered matching algorithm connects the right talent with the right opportunities, saving hours of manual screening.
          </p>
        </div>
      </div>
    </div>
